    ...
    event.findAll({
      ...
      participant.findAll({
        ...
        event.findAll({
          ...
          // console.log(data.join_event[0]);
          res.render("holdEvent", { data });
          // console.log(item);
        })
      })
    })
...
router.post('/delete/:id', function (req, res) {
  console.log("mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm".rainbow );
